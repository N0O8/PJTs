...
//				strData = theApp.m_khOpenApi.CommGetData(sTrcode, _T(""), strRQName, i, lstOPT10001[j].strKey);	strData.Trim();
				arrData.Add(strData);
			}
...
//				strData = theApp.m_khOpenApi.CommGetData(sTrcode, _T(""), strRQName, i, lstOPT10003[j].strKey);	strData.Trim();
				if (j == nFieldCnt - 1)
				{	// 백만단위
...
//			strData = theApp.m_khOpenApi.CommGetData(sJongmokCode, sRealType, lstOPT10001[i].strRealKey, 0,  _T(""));	strData.Trim();
			arrData.Add(strData);
		}
...
//			strData = theApp.m_khOpenApi.CommGetData(sJongmokCode, sRealType, lstOPT10003[i].strRealKey, 0, _T(""));	strData.Trim();
			arrData.Add(strData);
		}
...
//			strData = theApp.m_khOpenApi.CommGetData(sJongmokCode, sRealType, lstOPT10001_B[i].strRealKey, 0,  _T(""));	strData.Trim();
			arrData.Add(strData);
		}
		SetDataJongInfoGrid(arrData, sRealType);
	}
...
//			strData = theApp.m_khOpenApi.CommGetData(sJongmokCode, sRealType, lstOPT10004[i].strRealKey, 0, _T(""));	strData.Trim();
			arrData.Add(strData);
		}
